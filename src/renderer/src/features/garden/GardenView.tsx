...
function GardenView({
  ...
  onPickFlower,
  wateringDisabled
}: GardenViewProps): React.JSX.Element {
        ...
        return (
          <>
            <div className="garden-toolbar">
              ...
              >
                <span
                  style={{ width: 16, height: 16, display: 'inline-block', position: 'relative' }}
                >
                  <span
                    style={{
                      position: 'absolute',
                  ...
                  return (
                    <article
                      ...
                      className={[
                        ...
                        item.rarity === 'shiny' ? 'flower-rarity-shiny' : '',
                        item.rarity === 'stellar' ? 'flower-rarity-stellar' : '',
                        item.rarity === 'legendary' ? 'flower-rarity-legendary' : '',
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center gap-1">
                        ...
                        <span
                          className={`text-[11px] ${isWithered ? 'text-red-500' : 'text-[var(--text-secondary)]'}`}
                        >
                          {growthStageLabel}
                        </span>
